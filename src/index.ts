...
export { FactEnvelope, FactPath, FactRecord, FactReference, factReferenceEquals, FactFeed as FactStream, FactTuple, FactSignature, PredecessorCollection, Storage } from './storage';
