                    ...
                    for (const permutation of permutations) {
                        if (skeletonsEqual(ruleSkeleton, targetSkeleton)) {
                            if (rule.user === null) {
                                ...
                                const intersectedSpecification = intersectSpecificationWithDistributionRule(ruleFeed, rule.user);
                                // const intersectedFeeds = buildFeeds(intersectedSpecification);
                                feeds = [...feeds, intersectedSpecification];
                            }
                        }
                    }
                }
