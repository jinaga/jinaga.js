...
const specification_parser_1 = require("../../src/specification/specification-parser");
const description_1 = require("../../src/specification/description");
describe("Given Conditions", () => {
    function parseSpecification(input) {
        const parser = new specification_parser_1.SpecificationParser(input);
    ...
    it("should describe given with existential condition correctly", () => {
        ...
        const description = (0, description_1.describeSpecification)(specification, 0);
...
//# sourceMappingURL=givenConditionsSpec.js.map