...
describe("Feedback authorization", () => {
    ...
    it("should have logged in user", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("should not allow a comment from another user", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const content = yield j.fact(new Content(site, "/path/to/content"));
...
//# sourceMappingURL=authorizationExampleSpec.js.map