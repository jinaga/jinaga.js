...
describe('Hash', () => {
    it('should be independent of field order', () => {
        const hash1 = (0, _src_1.computeHash)({
            a: 'one',
            b: 'two'
        }, {});
        const hash2 = (0, _src_1.computeHash)({
            b: 'two',
            a: 'one'
        }, {});
    ...
    it('should verify hash', () => {
        const records = (0, _src_1.dehydrateFact)({
            type: 'Child',
            parent: {
                type: 'Parent',
                identifier: 'fee'
        ...
        expect((0, _src_1.verifyHash)(records[0])).toBeTruthy();
        expect((0, _src_1.verifyHash)(records[1])).toBeTruthy();
    });
});
describe('Nullable Predecessors', () => {
    it('should create fact with null predecessor and omit it from canonical form', () => {
        ...
        const records = (0, _src_1.dehydrateFact)(factWithNullPredecessor);
        ...
        const hydration = new _src_1.Hydration(records);
    ...
    it('should create fact with undefined predecessor and omit it from canonical form', () => {
        ...
        // When dehydrating the fact
        const records = (0, _src_1.dehydrateFact)(factWithUndefinedPredecessor);
        // Then no exception should be thrown during creation
        expect(records).toBeDefined();
        expect(records.length).toBe(1);
...
describe('Fact Validation', () => {
    it('should omit predecessor when fact contains null predecessor', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const createdFact = yield j.fact(factWithNullPredecessor);
...
describe("Fact with null predecessor", () => {
    it("should create a fact and omit null predecessors in canonical form and deserialization", () => __awaiter(void 0, void 0, void 0, function* () {
        // Given a Jinaga instance
        const j = _src_1.JinagaTest.create({});
        const parent = yield j.fact({
            type: "Parent",
            name: "Parent Fact"
        });
...
//# sourceMappingURL=factSpec.js.map